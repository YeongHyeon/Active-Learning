...
def main():
    ...
    dataset = dman.DataSet(dataname=FLAGS.dataname)
    ...
    time_tr = time.time()
    proc.training(agent=agent, dataset=dataset, batch_size=FLAGS.batch, epochs=FLAGS.epochs, sub_k=FLAGS.sub_k, n_stage=FLAGS.n_stage)
    time_te = time.time()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataname', type=str, default="cifar10", help='')
    ...
    parser.add_argument('--sub_k', type=int, default=1000, help='')
    parser.add_argument('--n_stage', type=int, default=10, help='')
